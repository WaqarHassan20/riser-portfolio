...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto px-20 md:px-44 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-linear-to-br from-[#084B73] to-purple-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xl">RX</span>
              </div>
              <span className="text-xl font-bold text-white">The Risers Consultancy</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@therisersconsultancy.com</span>
              </li>
            </ul>
          </div>
        </div>
